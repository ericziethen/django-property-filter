...
def test_supported_lookups(lookup):
    ...
    PropertyDateTimeFromToRangeFilter(property_fld_name='fake_field', lookup_expr=lookup)


def test_unsupported_lookup():
    with pytest.raises(ValueError):
        PropertyDateTimeFromToRangeFilter(property_fld_name='fake_field', lookup_expr='fake-lookup')
...
def fixture_property_time_range_filter():
    ...
    DateTimeFromToRangeFilterModel.objects.update_or_create(id=-1, date_time=datetime.datetime(2020, 1, 1, 13, 30, tzinfo=tz))
    DateTimeFromToRangeFilterModel.objects.update_or_create(id=0, date_time=datetime.datetime(2020, 1, 1, 13, 40, tzinfo=tz))
    DateTimeFromToRangeFilterModel.objects.update_or_create(id=1, date_time=datetime.datetime(2020, 2, 2, 12, tzinfo=tz))
    DateTimeFromToRangeFilterModel.objects.update_or_create(id=2, date_time=datetime.datetime(2020, 2, 2, 12, 0, tzinfo=tz))
    DateTimeFromToRangeFilterModel.objects.update_or_create(id=3, date_time=datetime.datetime(2020, 2, 2, 12, 0, 0, tzinfo=tz))
    DateTimeFromToRangeFilterModel.objects.update_or_create(id=4, date_time=datetime.datetime(2021, 1, 1, 13, 30, tzinfo=tz))
    DateTimeFromToRangeFilterModel.objects.update_or_create(id=5, date_time=datetime.datetime(2021, 1, 1, 13, 30, tzinfo=tz))
    DateTimeFromToRangeFilterModel.objects.update_or_create(id=6, date_time=datetime.datetime(2022, 1, 1, 13, 30, tzinfo=tz))
...
def test_lookup_xpr(fixture_property_time_range_filter, lookup_xpr, lookup_val, result_list):
    ...
    class PropertyDateTimeFromToRangeFilterSet(FilterSet):
