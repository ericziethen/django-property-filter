...
LOOKUP_SUCCEED = [
    ...
    ('postgres_range_contains', slice(6, 13), slice(6, 13)),
    ('postgres_range_contains', slice(6, 13), slice(5, 13)),
    ('postgres_range_contains', slice(6, 13), slice(6, 14)),
    ('postgres_range_contains', slice(6, None), slice(6, 13)),
    ('postgres_range_contains', slice(None, 13), slice(6, 13)),
    ('postgres_range_contains', slice(6, 13), slice(6, None)),
    ('postgres_range_contains', slice(6, 13), slice(None, 13)),
    ('postgres_range_contained_by', slice(6, 13), slice(6, 13)),
    ('postgres_range_contained_by', slice(5, 13), slice(6, 13)),
    ('postgres_range_contained_by', slice(6, 14), slice(6, 13)),
    ('postgres_range_contained_by', slice(6, None), slice(6, None)),
    ('postgres_range_contained_by', slice(None, 13), slice(None, 13)),
    ('postgres_range_contained_by', slice(6, None), slice(6, 13)),
    ('postgres_range_contained_by', slice(None, 13), slice(6, 13)),
    ('postgres_range_overlap', slice(5, 10), slice(5, 10)),
    ('postgres_range_overlap', slice(5, 10), slice(7, 9)),
    ('postgres_range_overlap', slice(7, 9), slice(5, 10)),
    ('postgres_range_overlap', slice(5, 10), slice(2, 6)),
    ('postgres_range_overlap', slice(2, 6), slice(5, 10)),
    ('postgres_range_overlap', slice(5, 10), slice(8, 12)),
    ('postgres_range_overlap', slice(8, 12), slice(5, 10)),
    ('postgres_range_overlap', slice(5, 10), slice(None, 7)),
    ('postgres_range_overlap', slice(None, 7), slice(5, 10)),
    ('postgres_range_overlap', slice(5, 10), slice(7, None)),
    ('postgres_range_overlap', slice(7, None), slice(5, 10)),
    ('postgres_range_overlap', slice(7, None), slice(5, None)),
...
LOOKUP_FAILED = [
    ...
    ('in', [1, 3, 5], 4),
    ('postgres_range_exact', slice(6, 13), slice(1, 13)),
    ('postgres_range_exact', slice(6, 13), slice(6, 55)),
    ('postgres_range_exact', slice(6, 13), slice(4, 25)),
    ('postgres_range_contains', slice(6, 13), slice(7, 13)),
    ('postgres_range_contains', slice(6, 13), slice(6, 12)),
    ('postgres_range_contains', slice(6, 13), slice(5, 12)),
    ('postgres_range_contains', slice(6, 13), slice(7, None)),
    ('postgres_range_contains', slice(6, 13), slice(None, 12)),
    ('postgres_range_contains', slice(None, 13), slice(6, 14)),
    ('postgres_range_contains', slice(6, None), slice(5, 13)),
    ('postgres_range_contained_by', slice(7, 13), slice(6, 13)),
    ('postgres_range_contained_by', slice(6, 12), slice(6, 13)),
    ('postgres_range_contained_by', slice(5, 12), slice(6, 13)),
    ('postgres_range_contained_by', slice(7, None), slice(6, 13)),
    ('postgres_range_contained_by', slice(None, 12), slice(6, 13)),
    ('postgres_range_contained_by', slice(6, 13), slice(None, 13)),
    ('postgres_range_contained_by', slice(6, 13), slice(6, None)),
    ('postgres_range_overlap', slice(5, 10), slice(4, 5)),
    ('postgres_range_overlap', slice(4, 5), slice(5, 10)),
    ('postgres_range_overlap', slice(5, 10), slice(5, 5)),
    ('postgres_range_overlap', slice(5, 5), slice(5, 10)),
    ('postgres_range_overlap', slice(5, 10), slice(10, 10)),
    ('postgres_range_overlap', slice(10, 10), slice(5, 10)),
    ('postgres_range_overlap', slice(5, 10), slice(10, 11)),
    ('postgres_range_overlap', slice(10, 11), slice(5, 10)),
    ('postgres_range_overlap', slice(2, 4), slice(15, 25)),
    ('postgres_range_overlap', slice(5, 10), slice(11, None)),
    ('postgres_range_overlap', slice(11, None), slice(5, 10)),
    ('postgres_range_overlap', slice(5, 10), slice(None, 4)),
    ('postgres_range_overlap', slice(5, 10), slice(None, 5)),
    ('postgres_range_overlap', slice(None, 4), slice(5, 10)),
    ('postgres_range_overlap', slice(None, 5), slice(5, 10)),
